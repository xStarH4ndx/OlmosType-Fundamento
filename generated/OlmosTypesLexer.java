...
public class OlmosTypesLexer extends Lexer {
	...
	public static final int
		...
		ID=39, NUMBER=40, STRING=41, WS=42, COMMENT=43;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "ID", "NUMBER", "STRING", 
			"WS", "COMMENT"
		};
	}
	...
	public OlmosTypesLexer(CharStream input) {
		super(input);
